                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="list-group">
                                        ...
                                        <button type="button" class="list-group-item list-group-item-action"
                                            onclick="window.location.href='{{ route('client.addresses.create') }}'">
                                            Thêm địa chỉ mới
                                        </button>
                                    </div>
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary"
                                        id="closeModalButtonFooter">Hủy</button>
                            ...
                            @foreach ($cartItems as $item)
                                ...
                                <div class="d-flex mb-3">
                                    <img src="{{ asset('storage/' . $image) }}"
                                        style="width: 60px; height: 60px; object-fit: cover;" class="rounded me-3 border">
    ...
    <script>
        ...
        document.querySelectorAll('.list-group-item').forEach(item => {
            item.addEventListener('click', function() {
                ...
                document.querySelectorAll('.list-group-item').forEach(button => button.classList.remove(
                    'active'));
