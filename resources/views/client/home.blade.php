        ...
        <div class="container">
            <div class="flat-title style-between align-items-end wow fadeInUp">
                <div class="box-title">
                    ...
                    <p class="desc text-main text-md">Khám phá những sản phẩm phổ biến nhất của chúng tôi</p>
                </div>
                            ...
                            <div class="card-product style-center">
                                <div class="card-product-wrapper">
                                    <a href="{{ route('client.detailProduct', $product->id) }}" class="product-img">
                                        ...
                                        <img class="img-product" src="{{ asset('storage/' . $product->image_primary) }}"
                                            alt="{{ $product->name }}">
                                        <img class="img-hover" src="{{ asset('storage/' . $product->image_primary) }}"
                                            alt="{{ $product->name }}">
                                    </a>
                                    <div class="on-sale-wrap flex-column type-2">
                                        {{-- Tag Bán chạy --}}
                                ...
                                <div class="card-product-info text-center">
                                    ...
                                    <p class="price-wrap fw-medium">
                                        <span
                                            class="price-new">{{ number_format($product->firstVariant->price ?? 0, 0, ',', '.') }}
                                            ₫</span>
                                        <span
                                            class="price-old old-line">{{ number_format(($product->firstVariant->price ?? 0) * 1.2, 0, ',', '.') }}
                                            ₫</span>
                                    </p>
