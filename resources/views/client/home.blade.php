                                ...
                                <div class="swiper-slide">
                                    <div class="wg-cls style-square hover-img">
                                        <a href="shop-sub-collection.html" class="image img-style d-block">
                                            <img src="{{ Storage::url($category->image) }}" alt="cls"
                                                class="lazyload mx-auto d-block" style="width: 150px; height: 150px; object-fit: cover;">
                                        </a>
                                        <div class="cls-content text-center">
                                            <a href="shop-sub-collection.html"
                                                class="link text-md fw-medium">{{ $category->name }}</a>
                                        </div>
                                    </div>
                                </div>
                            @endforeach
    ...
    <section class="flat-spacing-8 bg-surface">
        <div class="container">
            <div class="flat-title style-between align-items-end wow fadeInUp">
                ...
                <a href="{{ route('client.viewAll') }}" class="btn-underline">View all</a>
            </div>
                                            ...
                                            <div class="card-product">
                                                <div class="card-product-wrapper">
                                                    <a href="product-detail.html" class="product-img">
                                                        ...
                                                        <img class="img-hover lazyload"
                                                            data-src="images/products/electronic/airpod-pro-pink.jpg"
                                                            src="images/products/electronic/airpod-pro-pink.jpg"
                                                            alt="image-product">
                                                    </a>
                                                    <div class="on-sale-wrap flex-column type-2">
                                                        <span class="on-sale-item">20% Off</span>
                                                    ...
                                                    <ul class="list-product-btn">
                                                        ...
                                                        <li>
                                                            <a href="javascript:void(0);"
                                                                class="bg-surface btn-quickview hover-tooltip tooltip-left box-icon quickview">
                                                                <span class="icon icon-view"></span>
                                                                <span class="tooltip">Quick View</span>
                                                            </a>
                                                        </li>
                                                        <li class="compare">
                                                            <a href="javascript:void(0);"
                                                                class="bg-surface btn-compare hover-tooltip tooltip-left box-icon">
                                                                <span class="icon icon-compare"></span>
                                                                <span class="tooltip">Add to Compare</span>
                                                            </a>
                                                        </li>
                                                ...
                                                <div class="card-product-info text-center">
                                                    <a href="product-detail.html"
                                                        ...
                                                        AirPods Pro 2 Wireless <br class="d-none d-xl-block">
                                                        Earbuds</a>
                                                    <p class="price-wrap fw-medium">
                                                        <span class="price-new">$170.00</span>
                                                        <span class="price-old old-line">$190.00</span>
                                                    ...
                                                    <ul class="list-color-product justify-content-center">
                                                        ...
                                                        <li
                                                            ...
                                                            <span class="swatch-value bg-red-2"></span>
                                                            <img class="lazyload"
                                                                data-src="images/products/electronic/airpod-pro-red.jpg"
                                                                src="images/products/electronic/airpod-pro-red.jpg"
                                                                alt="image-product">
                                                        </li>
                                                        <li
                                                            class="list-color-item color-swatch hover-tooltip tooltip-bot">
                                            ...
                                            <div class="card-product">
                                                <div class="card-product-wrapper">
                                                    <a href="product-detail.html" class="product-img">
                                                        <img class="img-product lazyload"
                                                            data-src="images/products/electronic/earbuds2-black.jpg"
                                                            src="images/products/electronic/earbuds2-black.jpg"
                                                            alt="image-product">
                                                        <img class="img-hover lazyload"
                                                            data-src="images/products/electronic/earbuds2-black.jpg"
                                                            src="images/products/electronic/earbuds2-black.jpg"
                                                ...
                                                <div class="card-product-info text-center">
                                                    <a href="product-detail.html"
                                                        class="name-product link fw-medium text-md">Fit
                                                        Pro True Wireless Bluetooth Earbuds</a>
                                                    <p class="price-wrap fw-medium">
                                                        <span class="price-new">$155.00</span>
                                                    ...
                                                    <ul class="list-color-product justify-content-center">
                                                        ...
                                                        <li
                                                            class="list-color-item color-swatch line hover-tooltip tooltip-bot">
                                                            <span class="tooltip">White</span>
                                                            <span class="swatch-value bg-white"></span>
                                                            <img class="lazyload"
                                                                data-src="images/products/electronic/earbuds2-white.jpg"
                                                                src="images/products/electronic/earbuds2-white.jpg"
                                                                alt="image-product">
                                                        </li>
                                                        <li
                                                            class="list-color-item color-swatch hover-tooltip tooltip-bot">
                                                            ...
                                                            <span class="swatch-value bg-light-pink-10"></span>
                                                            <img class="lazyload"
                                                                data-src="images/products/electronic/earbuds2-pink.jpg"
                                                                src="images/products/electronic/earbuds2-pink.jpg"
                                                                alt="image-product">
                                                        </li>
                                                    </ul>
                                                </div>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="card-product">
                                                <div class="card-product-wrapper">
                                                    <a href="product-detail.html" class="product-img">
                                                        <img class="img-product lazyload"
                                                            data-src="images/products/electronic/ss-s21.jpg"
                                                            src="images/products/electronic/ss-s21.jpg"
                                                            alt="image-product">
                                                        <img class="img-hover lazyload"
                                                            data-src="images/products/electronic/ss-s21-grey.jpg"
                                                            src="images/products/electronic/ss-s21-grey.jpg"
                                                            alt="image-product">
                                                    </a>
                                                    <ul class="list-product-btn">
                                                        <li>
                                                ...
                                                <div class="card-product-info text-center">
                                                    <a href="product-detail.html"
                                                        class="name-product link fw-medium text-md">Galaxy
                                                        S21 5G 128GB G991U <br class="d-none d-xl-block"> Unlocked
                                                        Smartphone</a>
                                                    <p class="price-wrap fw-medium">
                                                    ...
                                                    <ul class="list-color-product justify-content-center">
                                                        ...
                                                        <li
                                                            ...
                                                            <img class=" lazyload"
                                                                data-src="images/products/electronic/ss-s21-pink.jpg"
                                                                src="images/products/electronic/ss-s21-pink.jpg"
                                                                alt="image-product">
                                                        </li>
                                                    </ul>
                                                </div>
                                            ...
                                            <div class="card-product">
                                                <div class="card-product-wrapper">
                                                    <a href="product-detail.html" class="product-img">
                                                        <img class="img-product lazyload"
                                                            data-src="images/products/electronic/ss-smart-watch.jpg"
                                                            src="images/products/electronic/ss-smart-watch.jpg"
                                                            alt="image-product">
                                                        <img class="img-hover lazyload"
                                                            data-src="images/products/electronic/ss-smart-watch-white.jpg"
                                                            src="images/products/electronic/ss-smart-watch-white.jpg"
                                                ...
                                                <div class="card-product-info text-center">
                                                    <a href="product-detail.html"
                                                        class="name-product link fw-medium text-md">Samsung Galaxy 5 LTE
                                                        Smart <br class="d-none d-xl-block"> Watch</a>
                                                    <p class="price-wrap fw-medium">
                                                        <span class="price-new">$170.00</span>
                                                    </p>
                                                    <ul class="list-color-product justify-content-center">
                                ...
                                <div class="tf-mini-cart-item file-delete">
                                    <div class="tf-mini-cart-image">
                                        <a href="product-detail.html">
                                            <img class="lazyload"
                                                data-src="images/products/electronic/airpod-pro-black.jpg"
                                                src="images/products/electronic/airpod-pro-black.jpg" alt="img-product">
                                        </a>
                                    </div>
                                    <div class="tf-mini-cart-info">
                                        <div class="d-flex justify-content-between">
                                            <a class="title link text-md fw-medium" href="product-detail.html">Apple
                                                AirPods Pro 2 Wireless Earbuds</a>
                                ...
                                <div class="tf-mini-cart-item file-delete">
                                    <div class="tf-mini-cart-image">
                                        <a href="product-detail.html">
                                            <img class="lazyload"
                                                data-src="images/products/electronic/ss-smart-watch.jpg"
                                                src="images/products/electronic/ss-smart-watch.jpg" alt="img-product">
                                        </a>
                                    </div>
                                    <div class="tf-mini-cart-info">
                                        <div class="d-flex justify-content-between">
                                            <a class="title link text-md fw-medium" href="product-detail.html">Samsung
                                    ...
                                    <div class="swiper-wrapper">
                                            ...
                                            <div class="tf-mini-cart-item line radius-16">
                                                ...
                                                <div class="tf-mini-cart-info justify-content-center">
                                                    <a class="title link text-md fw-medium"
                                                        href="product-detail.html">Fit Pro True Wireless Bluetooth
                                                        Earbuds</a>
                                                    <p class="price-wrap text-sm fw-medium">
                                                        <span class="new-price text-primary">$155.00</span>
                                                        <span
                                                            class="old-price text-decoration-line-through text-dark-1">$170.00</span>
                                                    </p>
                                                    <a href="#"
                                        ...
                                        <div class="swiper-slide">
                                            <div class="tf-mini-cart-item line radius-16">
                                                ...
                                                <div class="tf-mini-cart-info justify-content-center">
                                                    <a class="title link text-md fw-medium"
                                                        href="product-detail.html">Galaxy S21 5G 128GB G991U</a>
                                                    <p class="price-wrap text-sm fw-medium">
                                                ...
                                                <div class="tf-mini-cart-image">
                                                    <a href="product-detail.html">
                                                        <img class="lazyload"
                                                            ...
                                                            src="images/products/electronic/ipad-pro11-mini.jpg"
                                                            alt="img-product">
                                                    </a>
                                                </div>
                                                <div class="tf-mini-cart-info justify-content-center">
                                                    <a class="title link text-md fw-medium"
                                                        href="product-detail.html">Apple iPad Pro 11-inch Wi-Fi</a>
                                                    <p class="price-wrap text-sm fw-medium">
                    ...
                    <div dir="ltr" class="swiper tf-single-slide">
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide" data-color="black">
                                <div class="item">
                                    <img class="lazyload" data-src="images/products/electronic/airpod-pro-black.jpg"
                                        src="images/products/electronic/airpod-pro-black.jpg" alt="">
                                </div>
                            </div>
                            ...
                            <div class="swiper-slide" data-color="red">
                                <div class="item">
                                    <img class="lazyload" data-src="images/products/electronic/airpod-pro-red.jpg"
                                        src="images/products/electronic/airpod-pro-red.jpg" alt="">
                                </div>
                            </div>

                            <div class="swiper-slide" data-color="pink">
                                <div class="item">
                                    <img class="lazyload" data-src="images/products/electronic/airpod-pro-pink.jpg"
                                        src="images/products/electronic/airpod-pro-pink.jpg" alt="">
                                </div>
                            </div>
                        </div>
                ...
                <div class="tf-product-info-wrap">
                    <div class="tf-product-info-inner">
                        <div class="tf-product-heading">
                            <h6 class="product-name"><a href="product-detail.html" class="link">Apple AirPods Pro 2
                                    Wireless Earbuds</a></h6>
                            <div class="product-price">
                                <h6 class="price-new price-on-sale">$170.00</h6>
                                <h6 class="price-old">$190.00</h6>
                                <span class="badge-sale">20% Off</span>
                            </div>
                            <p class="text">Wireless earbuds with a sleek, ergonomic design for all-day comfort.
                                Features active noise cancellation, touch controls, and a long-lasting battery.</p>
                        </div>
                ...
                <div class="main-product-quickadd card-product">
                    <div class="item-product-info">
                        <div class="product-img">
                            <img class="img-product lazyload" data-src="images/products/electronic/airpod-pro-black.jpg"
                                src="images/products/electronic/airpod-pro-black.jpg" alt="image-product">
                        </div>
                        <div class="content-box">
                            <a href="product-detail.html" class="name-product link text-lg">Apple AirPods Pro 2 Wireless
                                Earbuds</a>
                    ...
                    <div class="item-product-variant">
                        <div class="quickadd-variant-color">
                            ...
                            <ul class="list-color-product">
                                ...
                                <li class="list-color-item color-swatch hover-tooltip tooltip-bot">
                                    <span class="tooltip color-label">Red</span>
                                    <span class="swatch-value bg-red-2"></span>
                                    <img class="lazyload" data-src="images/products/electronic/airpod-pro-red.jpg"
                                        src="images/products/electronic/airpod-pro-red.jpg" alt="image-product">
                                </li>
                                <li class="list-color-item color-swatch hover-tooltip tooltip-bot">
                                    <span class="tooltip color-label">Pink</span>
                                    <span class="swatch-value bg-light-pink-10"></span>
                                    <img class="lazyload" data-src="images/products/electronic/airpod-pro-pink.jpg"
                                        src="images/products/electronic/airpod-pro-pink.jpg" alt="image-product">
                                </li>
                    ...
                    <div class="tf-compare-inner">
                        <div class="tf-compare-list">
                            <div class="tf-compare-item file-delete">
                                ...
                                <div class="content">
                                    <div class="text-title">
                                        <a class="link text-line-clamp-2" href="product-detail.html">Apple AirPods Pro 2
                                            Wireless Earbuds</a>
                                    </div>
                                    <p class="price-wrap">
                                        <span class="new-price text-primary">$170.00</span>
                            ...
                            <div class="tf-compare-item file-delete">
                                ...
                                <a href="product-detail.html" class="image">
                                    <img class="lazyload" data-src="images/products/electronic/earbuds2-black.jpg"
                                        src="images/products/electronic/earbuds2-black.jpg" alt="">
                                </a>
                                <div class="content">
                                    <div class="text-title">
                                        <a class="link text-line-clamp-2" href="product-detail.html">Samsung Galaxy S20
                                            FE 5G, 128GB</a>
                                    </div>
                                    <p class="price-wrap">
                            ...
                            <div class="tf-compare-item file-delete">
                                ...
                                <a href="product-detail.html" class="image">
                                    <img class="lazyload" data-src="images/products/electronic/ss-smart-watch.jpg"
                                        src="images/products/electronic/ss-smart-watch.jpg" alt="">
                                </a>
                                <div class="content">
                                    <div class="text-title">
                                        <a class="link text-line-clamp-2" href="product-detail.html">Samsung Galaxy 5
                                            LTE Smart Watch</a>
                                    </div>
                                    <p class="price-wrap">
                                        <span class="new-price">$170.00</span>
