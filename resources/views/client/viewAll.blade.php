            ...
            <div class="container">
                <div class="box-title text-center">
                    ...
                    <div class="breadcrumb-list">
                        ...
                        <a class="breadcrumb-item" href="shop-collection-list.html">Collections</a>
                        <div class="breadcrumb-item dot"><span></span></div>
                        <div class="breadcrumb-item current">Women</div>
                    </div>
                    <p class="desc text-md text-main">Discover our carefully curated women's collection, where timeless
                        ...
                        <div class="swiper-slide">
                            <div class="tf-icon-box style-2">
                                ...
                                <div class="content">
                                    ...
                                    <p class="desc text-grey-2">We're here for you anytime with 24/7 customer support.
                                    </p>
                                </div>
                            </div>
                        </div>
