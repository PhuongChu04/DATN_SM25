        ...
        <div class="container">
            <div class="footer-bottom-wrap">
                ...
                <ul class="tf-payment">
                    ...
                    <li class="item"><img src="{{ asset('client/images/payment/DinersClub.png') }}" alt="payment"></li>
                    <li class="item"><img src="{{ asset('client/images/payment/Discover.png') }}" alt="payment"></li>
                    <li class="item"><img src="{{ asset('client/images/payment/GooglePay.png') }}" alt="payment"></li>
                    <li class="item"><img src="{{ asset('client/images/payment/Mastercard-2.png') }}" alt="payment"></li>
                    <li class="item"><img src="{{ asset('client/images/payment/Mastercard.png') }}" alt="payment"></li>
                    <li class="item"><img src="{{ asset('client/images/payment/Shop.png') }}" alt="payment"></li>
                    <li class="item"><img src="{{ asset('client/images/payment/UnionPay.png') }}" alt="payment"></li>
                    <li class="item"><img src="{{ asset('client/images/payment/Visa.png') }}" alt="payment"></li>
                </ul>
            </div>
        </div>
    </div>
