        ...
        <div class="container">
            <div class="box-title text-center">
                ...
                <div class="breadcrumb-list">
                    ...
                    <a class="breadcrumb-item" href="{{ route('client.listProducts') }}">Sale</a>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="wrapper-shop tf-grid-layout tf-col-4" id="gridLayout">
                    ...
                    @foreach ($products as $item)
                        <div class="card-product grid card-product-size" data-availability="In stock"
                            data-brand="Vineta">
                            <div class="card-product-wrapper">
                                <a href="{{ route('client.detailProduct', ['id' => $item->id]) }}" class="product-img">
                            ...
                            <div class="card-product-info">
                                ...
                                <a href="product-detail.html"
                                    class="name-product link fw-medium text-md">{{ $displayName }}</a>
