            ...
            <div class="card shadow border-0 rounded-4 modern-card animate-fade">
                ...
                <div class="card-header border-0 bg-white px-4 pt-4 pb-0">
                    <h4 class="fw-bold text-dark mb-1 d-flex align-items-center">
                        <i class="bi bi-plus-circle-fill text-success me-2"></i> Thêm Size
                    </h4>
                    <p class="text-muted mb-0">Nhập thông tin size mới vào form bên dưới</p>
                </div>

                <!-- Form -->
                <form action="{{ route('admin.size.storeSize') }}" method="POST" class="p-4">
                    @csrf
                    <div class="mb-4">
                    ...
                    <div class="d-flex justify-content-end">
                        <button type="submit" 
                                onclick="return confirm('Bạn có muốn thêm size này không?')" 
