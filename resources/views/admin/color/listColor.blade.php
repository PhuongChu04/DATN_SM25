                                                       ...
                                                       <tr>
                                                            ...
                                                            <td>
                                                                 <div class="d-flex gap-2">
                                                                      ...
                                                                      <a href="{{route('admin.color.deleteColor', $color->id)}}" class="btn btn-soft-danger btn-sm" onclick="return confirm('delete?')"><iconify-icon icon="solar:trash-bin-minimalistic-2-broken" class="align-middle fs-18"></iconify-icon></a>
                                                                 </div>
                                                            </td>
                                                       </tr>
                                                       @endforeach
