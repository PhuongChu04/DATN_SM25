                ...
                <tr>
                    ...
                    <td>
                        @if ($review->admin_reply)
                                <strong>{{ $review->admin->first_name ?? 'Admin' }}:</strong> {{ $review->admin_reply }}<br>
                   ...
                   <td>
                        <div class="d-flex align-items-center gap-2">
                            @if ($review->admin_reply)
                                ...
                                <form action="{{ route('admin.reviews.destroy', $review->id) }}" method="POST" onsubmit="return confirm('Bạn chắc chắn muốn xóa?');">
                                    @csrf
                                    @method('DELETE')
