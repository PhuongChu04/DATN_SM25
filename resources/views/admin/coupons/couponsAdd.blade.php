                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="status" value="2" id="status">
                                        <label class="form-check-label" for="status">
                                            Future Plan
                                        </label>
                                   </div>
                         ...
                         <div class="row">
                              <div class="col-lg-6">
                                   <div class="mb-3">
                                        ...
                                        <input type="text" id="coupons-name" name="coupons_name" class="form-control" placeholder="Name enter">
                                   </div>
                              </div>
                              <div class="col-lg-6">
                                   <div class="mb-3">
                                        <label for="coupons-code" class="form-label">Coupons Quantity</label>
                                        <input type="number" id="coupons_quantity" name="coupons_quantity" class="form-control" min="1" placeholder="Quantity enter">
                                   </div>
                              </div>
                         </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" id="coupons-code" name="coupons_code" class="form-control" placeholder="Code enter">
                                   </div>
                                </div>
                                <div class="col-lg-6">
                            ...
                            <div class="row mb-3">
                                <div class="col-lg-4">
                                    <div class="d-flex gap-2 align-items-center">
                                        <div class="form-check">
                                             <input class="form-check-input" type="radio" name="type" value="0" id="type" checked="">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="type" value="1" id="type">
                                        <label class="form-check-label" for="type">
                                            Percentage
                                        </label>
                                   </div>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="type" value="2" id="type">
                                        <label class="form-check-label" for="type">
                                            Fixed Amount
                                        </label>
                                   </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="">
                                        ...
                                        <input type="text" id="discount-value" name="discount_amount" class="form-control" placeholder="Discount Amount">
                                   </div>
                                </div>
                            </div>
                            <div class="row">
                              <div class="col-lg-12">
                                  <div class="">
                                      ...
                                      <textarea type="note" id="note" name="note" class="form-control" placeholder="Note"></textarea>
                                 </div>
                              </div>
                          </div>
                        </div>
