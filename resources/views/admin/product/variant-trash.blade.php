...
<div class="container-xxl">
    <form action="{{ route('admin.product.variant.restore') }}" method="POST" id="bulkRestoreForm">
        @csrf
        <div class="row">
            <div class="col-xl-12">
                <div class="card">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex gap-2">
                                                <form action="{{ route('admin.product.variant.restore') }}" method="POST" style="display:inline">
                                                    @csrf
                                                ...
                                                <form action="{{ route('admin.product.variant.forceDelete') }}" method="POST" style="display:inline">
                                                    @csrf
                                                    <input type="hidden" name="ids[]" value="{{ $variant->id }}">
                    ...
                    <div class="card-footer border-top">
                        ...
                        <form action="{{ route('admin.product.variant.forceDelete') }}" method="POST" style="display:inline" id="bulkDeleteForm">
                            @csrf
                        ...
                        <a href="{{ route('admin.product.listProduct') }}" class="btn btn-secondary ms-2">Quay lại</a>
                    </div>
                </div>
            </div>
        </div>
