...
<div class="container-xxl">
    <form action="{{ route('admin.product.bulkRestore') }}" method="POST">
        @csrf
        @method('POST')
        <div class="row">
            <div class="col-xl-12">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex gap-2">
                                                    <a href="{{ route('admin.product.restore', $product->id) }}" class="btn btn-soft-success btn-sm" onclick="return confirm('Khôi phục?')">
                                                        <iconify-icon icon="solar:refresh-circle-broken" class="align-middle fs-18"></iconify-icon>
                                                    </a>
                                                    <a href="{{ route('admin.product.forceDelete', $product->id) }}" class="btn btn-soft-danger btn-sm" onclick="return confirm('Xóa vĩnh viễn?')">
